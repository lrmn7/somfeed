...
const CreatePostForm = ({ onPostCreated }: { onPostCreated: () => void }) => {
    ...
    const canPost = !isLoading && isConnected && !isOverLimit && (!!content.trim() || !!imageFile);
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {imagePreview && (
                        <div className="relative mt-2">
                            <img src={imagePreview} alt="Image preview" className="rounded-xl max-h-80 w-auto" />
                            <button
                                type="button"
                                onClick={() => {
                                    setImageFile(null);
                    ...
                    <div className="flex justify-between items-center mt-4">
                        ...
                        <div className="flex items-center">
                            <span className={`text-sm mr-4 ${isOverLimit ? 'text-red-500' : 'text-gray-500'}`}>
                                {charCount}/{MAX_CHARS}
                            </span>
                            <button
                                type="submit"
